...
public class RestoreLevelExpTask extends BukkitRunnable {

    private final Player player;

    public RestoreLevelExpTask(Player player) {
        this.player = player;
    }

    @Override
    public void run() {
        DuelistUtil.retreiveLevelsAndExp(DuelistManager.getDuelist(player));
    }
